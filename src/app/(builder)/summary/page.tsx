...
const Summary = (props: Props) => {
  ...
  return (
    <div className="flex flex-col font-lato mt-10 overflow-y-auto px-4">
      {/* Model */}
      <div className="flex flex-col items-start lg:items-center  gap-5">
        ...
        <p className="text-[16px] lg:text-[18px] text-t-lightgrey text-left">
      ...
      <div className="flex flex-col items-start lg:items-center mb-8">
        <h3 className="text-[18px] text-t-grey font-bold mb-6 ">ACCESSORIES</h3>
